...
| `image` | Specify the image to use for the Densify Container Optimization Data Forwarder. | `registry.connect.redhat.com/densify/container-data-collection-forwarder:latest` |
